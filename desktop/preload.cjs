...
contextBridge.exposeInMainWorld('ccNexusDesktop', {
  ...
  saveAgent: (agent) => ipcRenderer.invoke('desktop:save-agent', agent),
  deleteAgent: (id) => ipcRenderer.invoke('desktop:delete-agent', { id }),
  setSelectedAgent: (id) => ipcRenderer.invoke('desktop:set-selected-agent', { id }),
  exportAgents: () => ipcRenderer.invoke('desktop:export-agents'),
  importAgents: (payload) => ipcRenderer.invoke('desktop:import-agents', payload),
  ...
  searchWeb: (args) => ipcRenderer.invoke('desktop:web-research-search', args),
  fetchWebContent: (args) => ipcRenderer.invoke('desktop:web-research-fetch', args),
